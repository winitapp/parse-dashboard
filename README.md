...
| `deleteOptions`             | Object              | yes      | see note  | -                    | -                                    | `{ "class": false }`              | WinIt: granular delete toolbar gates (`class`, `columns`, `selectedRows`, `allData`; default all `true`). |
| `exportOptions`             | Object              | yes      | see note  | -                    | -                                    | `{ "allData": false }`            | WinIt: granular export toolbar gates (`schema`, `selectedRows`, `allData`; default all `true`). |
| `securityOptions`           | Boolean             | yes      | `true`    | -                    | -                                    | `false`                           | WinIt: when `false`, hide Security dialog in the data browser.                                              |
